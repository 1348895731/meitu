...
import com.example.administrator.cameraresultproject.R;
import com.example.administrator.cameraresultproject.SettingPopUpWindow;
...
public class GalleryPopUpWindow extends SettingPopUpWindow
    ...
    public GalleryPopUpWindow(Context context, GalleryLayoutManager galleryLayoutManager, RecyclerView recyclerView) {
        super(context);
