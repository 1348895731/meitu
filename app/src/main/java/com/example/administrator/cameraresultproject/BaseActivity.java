...
public abstract class BaseActivity<V extends ViewPagerLayoutManager, S extends SettingPopUpWindow>
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewPagerLayoutManager = createLayoutManager();
          mDataAdapter= new DataAdapter(new DataAdapter.Onclick() {
              @Override
    ...
    public void setReLayoutManager(ViewPagerLayoutManager layout){
       int position= viewPagerLayoutManager.getCurrentPosition();
        viewPagerLayoutManager=(V)layout;
        recyclerView.setLayoutManager(viewPagerLayoutManager);
        recyclerView.scrollToPosition(position);

    }

    public  void changType(boolean isLinear){
        mDataAdapter.changeLinearLayoutSize(isLinear,true);
    }
