...
public class CircleScaleLayoutManager extends ViewPagerLayoutManager {
    ...
    private CircleScaleLayoutManager(Context context, int radius, float angleInterval, float centerScale,
...
//        itemView.setScaleY(scale);
    ...
    public static class Builder {
        private static float INTERVAL_ANGLE = 30f;// The default mInterval angle between each items
        ...
        public Builder setAngleInterval(float angleInterval) {
            this.angleInterval = angleInterval;
            return this;
        }
